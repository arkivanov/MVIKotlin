...
import com.arkivanov.mvikotlin.core.debug.R
...
//    }
    ...
    private class Adapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
        ...
        fun setEvents(events: List<TimeTravelEvent>, selectedEventIndex: Int) {
            ...
            val newEvents = Events(items = events, index = selectedEventIndex)
            this.events = newEvents

            DiffUtil
                .calculateDiff(DiffCallback(oldEvents, newEvents), true)
