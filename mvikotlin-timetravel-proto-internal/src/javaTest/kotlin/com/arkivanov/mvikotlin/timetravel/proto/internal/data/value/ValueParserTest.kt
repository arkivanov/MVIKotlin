        ...
        ValueNode(
            ...
            children = listOf(
                ...
                ValueNode(
                    ...
                    value = "{IntArray[2]}",
                    children = listOf(
                        ValueNode(name = "[0]", value = "1"),
                        ValueNode(name = "[1]", value = "2"),
                    )
                ),
                ValueNode(
                    name = "longArray",
                ...
                ValueNode(
                    ...
                    value = "{FloatArray[2]}",
                    children = listOf(
                        ValueNode(name = "[0]", value = "1.0"),
                        ValueNode(name = "[1]", value = "2.0"),
                    )
                ),
                ValueNode(
                    name = "doubleArray",
                ...
                ValueNode(
                    ...
                    value = "{CharArray[2]}",
                    children = listOf(
                        ValueNode(name = "[0]", value = "a"),
                        ValueNode(name = "[1]", value = "b"),
                    )
                ),
                ValueNode(
                    name = "booleanArray",
                    ...
                    children = listOf(
                        ValueNode(name = "[0]", value = "true"),
                        ValueNode(name = "[1]", value = "false"),
                    )
                ),
                ValueNode(
                    name = "stringArray",
